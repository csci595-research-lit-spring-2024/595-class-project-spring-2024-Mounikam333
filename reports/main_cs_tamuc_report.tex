...
\begin{document}
    ...
    \cite{Wager2014AsymptoticTF}

    \cite{SAKR2011888}

    \cite{sakr2010artificial}

    \cite{shabbar2011prediction}

    \cite{castelli2015predicting}

    \cite{cortez2007data}

    \cite{shidik2014predicting}

    \cite{bedia2015global}

    \cite{carvalho2008fire}

    \cite{guan2023predicting}
